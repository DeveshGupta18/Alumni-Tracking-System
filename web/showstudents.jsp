...
try {
	...
	boolean st = false;
			...
			PreparedStatement ps=conn.prepareStatement("select * from reg_alumni where cid=?");
                        ps.setInt(1,cid);
	...
	%>
	  ...
	  <td><%=rs.getString(2) %></td>
	   ...
	   <td><%=rs.getString(13) %></td>
           <td><center><a href="mail.jsp?email=<%=rs.getString(12)%>"><button class="button button1">
				<h3>Send Mail</h3>
                       </button></a></center></td>
                        </tbody>
	  </tr>
